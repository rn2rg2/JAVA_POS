	...
	public Index() {
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
						.addComponent(menu_category, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE)
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup().addGap(18)
		...
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addComponent(menu_category, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE)
								.addGroup(gl_contentPane.createSequentialGroup().addGap(6).addComponent(manager_btn,
										GroupLayout.PREFERRED_SIZE, 47, GroupLayout.PREFERRED_SIZE)))
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
								.addGroup(gl_contentPane.createSequentialGroup()
										.addComponent(menu_scroll_frame, GroupLayout.PREFERRED_SIZE, 417,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.RELATED))
								.addGroup(Alignment.LEADING,
										gl_contentPane.createSequentialGroup()
												.addComponent(menu_basket, GroupLayout.PREFERRED_SIZE, 417,
														GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(ComponentPlacement.RELATED)))
						.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
								.addGroup(gl_contentPane.createSequentialGroup()
										.addComponent(panel_4, GroupLayout.PREFERRED_SIZE, 50,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.RELATED, 18, Short.MAX_VALUE).addComponent(
												panel_2, GroupLayout.PREFERRED_SIZE, 50, GroupLayout.PREFERRED_SIZE))
		...
		gl_menu_category.setHorizontalGroup(gl_menu_category.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_menu_category.createSequentialGroup().addGap(17).addComponent(menu_category1)
						.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(menu_category2)
						.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(menu_category3)
						.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(menu_category4)
						.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(menu_category5)
						.addContainerGap(33, Short.MAX_VALUE)));
		gl_menu_category.setVerticalGroup(gl_menu_category.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_menu_category.createSequentialGroup().addContainerGap().addGroup(gl_menu_category
		...
		gl_menu_basket.setHorizontalGroup(gl_menu_basket.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_menu_basket.createSequentialGroup().addContainerGap()
						.addComponent(menu_detail, GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE).addContainerGap()));
		gl_menu_basket.setVerticalGroup(gl_menu_basket.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_menu_basket.createSequentialGroup().addContainerGap()
		...
		gl_menu_detail.setHorizontalGroup(
				gl_menu_detail.createParallelGroup(Alignment.LEADING).addGap(0, 165, Short.MAX_VALUE));
		gl_menu_detail
				.setVerticalGroup(gl_menu_detail.createParallelGroup(Alignment.LEADING).addGap(0, 61, Short.MAX_VALUE));
		...
		gl_menu_frame.setHorizontalGroup(gl_menu_frame.createParallelGroup(Alignment.LEADING).addGroup(gl_menu_frame
				.createSequentialGroup().addContainerGap()
				...
				.addContainerGap()));
		gl_menu_frame.setVerticalGroup(gl_menu_frame.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_menu_frame.createSequentialGroup().addContainerGap()
		...
		gl_menu_scroll_frame.setHorizontalGroup(gl_menu_scroll_frame.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_menu_scroll_frame.createSequentialGroup().addContainerGap()
						.addComponent(menu_frame, GroupLayout.PREFERRED_SIZE, 211, GroupLayout.PREFERRED_SIZE)
						.addContainerGap(466, Short.MAX_VALUE)));
		gl_menu_scroll_frame.setVerticalGroup(gl_menu_scroll_frame.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_menu_scroll_frame.createSequentialGroup().addContainerGap()
